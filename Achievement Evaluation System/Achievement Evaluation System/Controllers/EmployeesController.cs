...
namespace Achievement_Evaluation_System.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,National_ID,Sex,Fname,Mname,Lname,Mobile_number,Birth_date,Address,Job_position,Is_general_manager,Is_manager,Is_supervisor")] Employee employee)
        {
            if (ModelState.IsValid)
            {
